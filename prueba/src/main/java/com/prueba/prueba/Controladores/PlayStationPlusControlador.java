...
public class PlayStationPlusControlador {
    ...
    @PutMapping("/modificarPsPlus")
    public PlayStationPlus modificarPsPlus(@RequestBody PlayStationPlus playStationPlus){
        return playStationPlusServicio.modificarPlayStationPlus(playStationPlus);
    }

    @GetMapping("/obtenerPsPlus")
    public List<PlayStationPlus> obtenerPlayStationPlus(){
        return playStationPlusServicio.obtenerPlayStationPlus();
    }

    @DeleteMapping("/eliminarPsPlus")
    public void eliminarPlayStationPlus(@RequestParam Long idPlayStationPlus){
        playStationPlusServicio.eliminarPlayStationPlus(idPlayStationPlus);
    }
